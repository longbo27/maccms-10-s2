...
<meta charset="UTF-8">
<title>追远影视 - www.zhuiyuan.net</title>
...
<script>
    // 播放器基本设置
    var playlink ="<?php echo($_REQUEST['myurl']);?>",urlpar ='xiaodigu';
    var dmapi = '//www.zhuiyuan.net/dplayer/v3/',vodurl = '<?php echo($_REQUEST['url']);?>',vodid="<?php echo($_REQUEST['name']);?>",vodsid="<?php echo($_REQUEST['sid']);?>",vodpic="<?php echo($_REQUEST['pic']);?>",vodname="<?php echo($_REQUEST['name']);?>",next = "<?php echo($_REQUEST['next']);?>",ym="//www.zhuiyuan.net/";
    ...
    //弹幕礼仪链接
    //var dmrule = "http://v.8e.gs/artdetail-10/"
    //暂停广告
